...
var Server = function () {
    function Server() {
        ...
        this._app.use('/js', _express2.default.static(_path2.default.join(__dirname, '../public/js'), staticOptions));
        this._app.use('/imgs', _express2.default.static('../public/imgs', staticOptions));
        this._app.use('/sw.js', function (req, res) {
            return res.sendFile(_path2.default.resolve('../public/sw.js'), staticOptions);
        });
        this._app.use('/sw.js.map', function (req, res) {
            return res.sendFile(_path2.default.resolve('../public/sw.js.map'), staticOptions);
        });
        ...
        this._app.get('/countries.json', function (req, res) {
            return res.send(_countries2.default);
        });
        this._app.get('/currencies.json', function (req, res) {
        ...
        this._app.get('/', function (req, res) {
            return res.sendFile(_path2.default.join(__dirname, '../public/html', 'index.html'));
        });
    }
